...
class MoveGeneratorTest
{
	...
	@Test
	 void Test_Possible_Simple_Moves()  { //Move
...
//		Node node4= AbaloneGraph.get().getVertex('B',1);
	...
	@Test
	 void Test_AllPossible_Simple_Moves()  { //Move
	...
	@Test
	 void Test_Default_Board_Shift_Line_Moves() { //Move
		Layer layer = Layer.getDefaultBoard();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
	...
	@Test
	 void Test_Compute_NorthEast_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
	...
	@Test
	 void Test_Compute_East_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_SouthEast_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_SouthWest_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_West_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_NorthWest_Move()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_SideStep()  { //Move
		Layer layer = new Layer();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
		LineComputer lc= new LineComputer(layer);
	...
	@Test
	 void Test_Compute_All_Default_SideStep()  { //Move
		Layer layer = Layer.getDefaultBoard();
		NonPushMoveGenerator mg= new NonPushMoveGenerator(layer);
	...
	@Test
	void Test_Line_Push_Node_Move_Horizontal() { //Move
		Layer layer = Layer.getDefaultBoard();
		Line line= new Line();
