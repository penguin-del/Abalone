...
//abstract class 
	...
	public float getScore(Layer layer, MarbleColor playerColor) {
		...
		//		switch(oppositeColorMarblesKnockedOff) 
		//		{
		//		case 1:
		//			return (float) oppositeColorMarblesKnockedOff / weightOfMarbles;
		//
		//		case 2:
		//			return (float) oppositeColorMarblesKnockedOff / weightOfMarbles;
		//
		...
		//
		//		case 5:
		//			//ADDS 1 TO NUM OF MARBLES BECAUSE IT WEIGHS 1/7 MORE THAN REST OF THEM
		//			return (float) oppositeColorMarblesKnockedOff + 1 / weightOfMarbles;

	}


	private float calculatePoints(int numOfMarblesKnockedOff) {
